...
<div x-data="{ userDropdownOpen: false }" class="w-full">
    ...
    <div x-show="userDropdownOpen"
        ...
        @if(in_array(auth()->user()->role, ['admin', 'manager', 'landlord']))
            ...
            class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                <svg class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" fill="none" aria-hidden="true">
                    <!-- simple "control panel / sliders" icon for clarity -->
                    <line x1="4" y1="6" x2="14" y2="6" stroke-linecap="round"></line>
                    <circle cx="18" cy="6" r="2" fill="currentColor"></circle>

                    <line x1="4" y1="12" x2="10" y2="12" stroke-linecap="round"></line>
                    <circle cx="14" cy="12" r="2" fill="currentColor"></circle>

                    <line x1="4" y1="18" x2="8" y2="18" stroke-linecap="round"></line>
